...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-4">
        <div class="col-span-12">
            <x-form.form
                action="{{ route('sensores.update', $sensor->id_sensor) }}"
                method="PUT"
            ...
            >
                ...
                <div class="col-span-12 md:col-span-6">
                    <x-form.input
                        ...
                        type="text"
                        required
                        :value="old('ds_nome', $sensor->ds_nome ?? '')"
                ...
                <div class="col-span-12 md:col-span-6">
                    <x-form.select
                        ...
                        :value="old('tp_sensor', $sensor->tp_sensor?->value ?? '')"
                ...
                <div class="col-span-12 md:col-span-6">
                    <x-form.select
                        name="ds_status"
                        label="Status"
                        :options="\App\Enums\TipoStatusSensor::toSelectArray()"
                        :value="old('ds_status', $sensor->ds_status?->value ?? '')"
                        error="{{ $errors->first('ds_status') }}"
                        required
                    />
                </div>
                ...
                <div class="col-span-12 md:col-span-6">
                    <x-form.select
                        ...
                        :value="old('id_propriedade', $sensor->id_propriedade ?? '')"
                ...
                <div class="col-span-12 md:col-span-6">
                    ...
                    <select
                        ...
                        required
                        {{ $sensor->id_propriedade ? '' : 'disabled' }}
                    >
                        ...
                        @foreach($lavouras as $lavoura)
                            <option
                                ...
                                {{ (string) old('id_lavoura', $sensor->id_lavoura ?? '') === (string) $lavoura->id_lavoura ? 'selected' : '' }}
                            >
                                {{ $lavoura->ds_cultura }}
                            </option>
                        @endforeach
